...
class VisitsBloc extends HydratedBloc<VisitsEvent, VisitsState> {
  ...
  VisitsBloc({required this.repository, required this.database, required this.connectivity}) : super(const VisitsState()) {
  ...
  void _monitorConnectivity(MonitorConnectivity event, Emitter<VisitsState> emit) {
